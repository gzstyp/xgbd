...
public abstract class ListViewAdapter extends BaseAdapter{
	...
	*/
	public ListViewAdapter(final Activity activity,final ArrayList<HashMap<String, String>> list){
		this.list = list;
	...
	*/
	...
	public abstract View newView(final Activity activity,final HashMap<String,String> data,final ViewGroup parent,final int position);
